...
# -*- coding: utf-8 -*-
"""
It downloads the biotypes of all genes from the Ensembl database.
...
if __name__ == '__main__':
    ...
    usage = "%prog [options]"
    description = """It downloads the biotypes of all genes from the Ensembl database."""
    ...
    parser.add_option("--organism",
                      ...
                      help="""The name of the organism for which the genes biotypes are downloaded, e.g. homo_sapiens, mus_musculus, etc. Default is '%default'.""")
    ...
    parser.add_option("--output",
                      ...
                      default = '.',
                      help="""The output directory where the genes biotypes are stored. Default is '%default'.""")
...
#            <Attribute name = "ensembl_peptide_id" />
    ...
    biotypes_filename = os.path.join(options.output_directory,'biotypes.txt')
    biotypes_header_filename = os.path.join(options.output_directory,'biotypes_header.txt')
