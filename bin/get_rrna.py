...
# -*- coding: utf-8 -*-
"""
It downloads the rRNA sequences from the Ensembl database.
...
if __name__ == '__main__':
    ...
    usage = "%prog [options]"
    description = """It downloads the rRNA sequences from the Ensembl database."""
    ...
    parser.add_option("--organism",
                      ...
                      help="""The name of the organism for which the rRNA sequences are downloaded, e.g. homo_sapiens, mus_musculus, etc. Default is '%default'.""")
    ...
    parser.add_option("--output",
                      ...
                      default = '.',
                      help="""The output directory where the rRNA sequences are stored. Default is '%default'.""")
    ...
    <Query  virtualSchemaName = "default" formatter = "FASTA" header = "0" uniqueRows = "0" count = "" datasetConfigVersion = "0.7" >
        <Dataset name = "%%%organism%%%" interface = "default" >
            <Filter name = "biotype" value = "rRNA"/>
    ...
    <Query  virtualSchemaName = "default" formatter = "FASTA" header = "0" uniqueRows = "0" count = "" datasetConfigVersion = "0.7" >
        <Dataset name = "%%%organism%%%" interface = "default" >
            <Filter name = "biotype" value = "Mt_rRNA"/>
            <Attribute name = "ensembl_gene_id" />
            <Attribute name = "gene_exon_intron" />
            <Attribute name = "description" />
        </Dataset>
    ...
    rrna_filename = os.path.join(options.output_directory,'rrna.fa')
    headers = {
