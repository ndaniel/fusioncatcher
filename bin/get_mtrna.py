...
# -*- coding: utf-8 -*-
"""
It downloads the mitochondrial RNA sequences from the Ensembl database.
...
if __name__ == '__main__':
    ...
    usage = "%prog [options]"
    description = """It downloads the mitochondrial RNA sequences from the Ensembl database."""
