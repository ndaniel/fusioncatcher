...
if __name__ == '__main__':
    ...
    if len(filenames)<=1:
        raise Exception("It is add on for blat_parallel.py by pre-filtering the fusion candidates from an input PSL file format generated by BLAT aligner.\nERROR: Not enough arguments!")
    ...
    if outfile != '-':
        if flag:
            fod.write('')
        fod.close()# Closing stdout is not desired, only close if outfile is different
    fid.close()
