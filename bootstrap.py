...
def PATHS(exe = None, prefix = None, installdir = None):
    ...
    FUSIONCATCHER_URL = 'http://sourceforge.net/projects/fusioncatcher/files/fusioncatcher_v0.99.3e.zip'
    ...
    NUMPY_URL = 'http://pypi.python.org/packages/source/n/numpy/numpy-1.8.1.tar.gz'
    # biopython
    ...
    SETUPTOOLS_URL = 'http://pypi.python.org/packages/source/s/setuptools/setuptools-5.7.tar.gz'
    # BOWTIE
    ...
    STAR_URL = 'http://github.com/alexdobin/STAR/archive/STAR_2.4.0g1.tar.gz'
    # faToTwoBit
    ...
    SRATOOLKIT_URL = 'http://ftp-private.ncbi.nlm.nih.gov/sra/sdk/2.3.5-2/sratoolkit.2.3.5-2-centos_linux64.tar.gz'
    # VELVET
    ...
    SEQTK_URL = 'http://github.com/ndaniel/seqtk/archive/1.0-r68e.tar.gz'
...
################################################################################
    ...
    if not options.skip_install_all:
        ...
        r = tool(name = "NCBI SRA Toolkit (sequence assembler for short reads)",
                 ...
                 versions = ('2.3.2','2.3.3','2.3.3-4','2.3.5-2'),
        ...
        if options.extra:
            ...
            r = tool(name = "PICARD (Java-based command-line utilities that manipulate SAM files)",
                     exe = "java -jar SamToFastq.jar",
                     param = "--version",
                     web = "<http://picard.sourceforge.net/>",
                     versions = ('1.119(d44cdb51745f5e8075c826430a39d8a61f1dd832_1408991805)',),
                     force = options.force_yes,
                     url = PICARD_URL,
                     path = PICARD_PATH,
                     install = options.install_all or options.install_all_tools,
